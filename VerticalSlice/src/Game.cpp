...
void Game::applyMatchConsequences(const std::vector<Gem>& matchedGems) {
    ...
    for (const auto& gem : matchedGems) {
        ...
        switch (gem.primaryType) {
            ...
            case PrimaryGemType::Attack:
                ...
                totalDamage += gem.level * 10; // 10 base damage per skull level
            ...
            case PrimaryGemType::Mana:
                ...
                std::cout << "Gained " << gem.level << " mana for subtype " << (int)gem.subType << std::endl;
            ...
            case PrimaryGemType::Treasure:
                ...
                std::cout << "Gained " << gem.level << " coins." << std::endl;
    ...
    if (totalDamage > 0) {
        ...
        std::cout << "Dealt " << totalDamage << " damage.\n";
    ...
    if (currentState == GameState::Animating) {
        ...
        if (isAnimatingSwap) {
            ...
            if (animationClock.getElapsedTime().asSeconds() >= swapAnimationDuration) {
                ...
                if (isRevertingInvalidSwap) {
                    ...
                    return; // The revert is done, exit the update loop.
                ...
                if (!matches.empty()) { // Swap resulted in a match
                    ...
                    board.processMatches(matches, matchedGems); // This now also extracts the matched gems
                    ...
                    isRevertingInvalidSwap = true; // Set the flag!

                    animatingGems = {t2, t1}; // Reverse the animation
        ...
        // 2. DESTRUCTION ANIMATION
            ...
            if (animationClock.getElapsedTime().asSeconds() >= destructionAnimationDuration) {
                ...
                // processMatches was already called, just need to apply gravity
